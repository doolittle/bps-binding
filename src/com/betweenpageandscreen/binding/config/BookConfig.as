...
import org.papervision3d.typography.Font3D;
  ...
  public class BookConfig {
    ...
    public static var SHOW_FPS:Boolean        = true; //Displays FPS monitor in lower left.
    ...
    public static var LOST_MARKER_TIMEOUT:Number = 30*10;
    ...
    // Display config.
    public static var DISPLAY_PADDING:Number  = 40;  // Padding around video frame.
    ...
    // Camera height/width
    private static var camera_width:uint = 640;
    public static function set CAMERA_WIDTH(n:uint):void {
      camera_width = n;
    }
    public static function get CAMERA_WIDTH():uint {
      return camera_width*SCALE;
    }

    private static var camera_height:uint = 480;
    public static function set CAMERA_HEIGHT(n:uint):void {
      camera_height = n;
    }

    public static function get CAMERA_HEIGHT():uint {
    ...
    public static function get SAMPLE_WIDTH():Number {
      return CAMERA_WIDTH*DOWNSAMPLE;
    }
    public static function get SAMPLE_HEIGHT():Number {
    ...
    public static var THRESHOLD:Number  = 80;

    private static var __room_brightness:String = BrightnessVO.AVERAGE;

    // Setting the room brightness
    // In a really awesome world, we'd automatically calibrate this.
