...
{
  import com.bookframework.models.vo.BrightnessVO;
  ...
  public class BookConfig {
    ...
    public static var COVER_ANIMATION:Boolean = false;
    ...
    public static var SCREEN_ALPHA:Number     = .5 //How white to make the screen over the image. Makes the black show up more. 
