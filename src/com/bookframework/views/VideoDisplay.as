package com.bookframework.views
{
  ...
  import com.bookframework.helpers.AnalyticsHelper;
  import com.bookframework.helpers.BookHelper;
  import com.bookframework.interfaces.iBookModule;
  import com.bookframework.models.CameraParams;
      ...
      if (webcam && (webcam.activityLevel > BookConfig.MOTION_LEVEL ||  !active_detector || !module)) { //Don't recalculate if there's no activity. stops flickering.
        ...
        if (detected ) {
          ...
          if (active_detector && (!module || lost_marker > 0)) {
            var temp:iBookModule = modules[active_detector]
            ...
            if (found_marker > TICK_DELAY && (module!=temp)) { //We new found a marker for a period of time, let's intro it. 
              ...
              BetweenAS3.tween(screen,{alpha:BookConfig.SCREEN_ALPHA},null,.5,Quad.easeIn).play()
          ...
          if (module && (lost_marker > TICK_DELAY)) {
            ...
            BetweenAS3.tween(screen,{alpha:0},null,.5,Quad.easeIn).play()
            module.remove()
            module = null;
          } 
          test_timeout();
